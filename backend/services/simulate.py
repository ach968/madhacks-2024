...
def single_trial(
    player_hand: Hand, num_opponents: int, stage: int, board: List[int], trials: int
):
    evaluator = Evaluator()
    wins = 0
...
def get_initial_guess(
    player_hand: Hand, num_opponents: int, stage: int, board: List[int], trials=100
):
...
def main():
    ...
    print(
        "for a risk tolerance factor of ",
        risk,
        " you should raise ",
        optim,
        " percent of your holdings",
    )
